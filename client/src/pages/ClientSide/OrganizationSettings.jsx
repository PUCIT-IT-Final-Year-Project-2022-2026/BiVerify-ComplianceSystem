  ...
  return (
    <nav style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        {/* Real logged-in user — same pattern as ServiceBookings.jsx */}
...
export default function OrganizationSettings() {
  // ── Form state (mirrors the fields in OrganizationSettings.jsx) ─────────────
  ...
  // ── Nav: real logged-in user (same pattern as ServiceBookings.jsx) ──────────
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Keep localStorage in sync so nav bar reflects new org name immediately
      try {
